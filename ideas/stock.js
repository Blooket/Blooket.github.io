		...
		function getQuestions(purpose, data) {
			...
			function question() {
				...
				var question = document.createElement('div');question.className = 'questionsQuestion';container.appendChild(question);question.innerHTML = 'Ask your Question HERE';
				var answer1 = document.createElement('div');
				var answer2 = document.createElement('div');
				if (Math.floor(Math.random() * 1.99) == 0) {
					answer1.className = 'questionsAnswer';container.appendChild(answer1);answer1.innerHTML = 'Correct Answer';
					answer2.className = 'questionsAnswer';container.appendChild(answer2);answer2.innerHTML = 'Incorrect Answer';
				} else {
					answer2.className = 'questionsAnswer';container.appendChild(answer2);answer2.innerHTML = 'Incorrect Answer';
					answer1.className = 'questionsAnswer';container.appendChild(answer1);answer1.innerHTML = 'Correct Answer';
				}
