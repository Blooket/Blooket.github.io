...
<html lang="en" >
	<head id="head">
		...
		<style>
			...
			.linkbutton{display:flex;align-items:center;flex-direction:row;flex:1;align-self:stretch;background-color:#0bc2cf;box-shadow:0 0 8px 3px rgba(0,0,0,.2);border-radius:6px;color:#fff;font-family:Nunito,sans-serif;outline:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;text-decoration:none;cursor:pointer;padding:15px 10px;min-width:180px;margin:7px;font-size:30px;line-height:27px;text-align:center;transition:.2s;align-self:center;align-content:center;}
			...
			.headerside{background-color:#0bc2cf;box-shadow:0 0 8px 3px rgba(0,0,0,.2);width:70vw;height:125vh;position:absolute;top:-10vh;left:-20vw;transform:rotate(-15deg);z-index:-1;}
			...
			.welcometext{font-size:8.83vh;line-height:9.13vh;text-shadow:2px 2px 8px grey;font-weight:700;}
			.welcomedesc{font-size:3.35vh;margin:3vh 0;}
			...
			<div class="stylesholder">
				<div class="headercontainer">
					...
					<div class="topheadercontainer">
						<div class="logotext">Booklet</div>
						<br>
					</div>
					<div class="welcomecontainer">
						<div class="welcometext">Useful<br>Organized<br>Links</div>
						<div class="welcomedesc">This is just a handful of useful links.<br>I will probably update this in the future and add more stuff.</div>
					</div>
				</div>
				<div class="menuholder">
					<div class="lowerbackground"></div>
					<div class="menutext">Helpful Links Menu</div>
					<div class="buttoncontainer">
						...
						<a target="_blank" class="linkbutton" href="https://discord.com/invite/BKpkvmb" style="background-color:#738adb;">
							<i class="fab fa-discord"></i>
							<div class="buttontext">Blooket Discord</div>
						</a>
						<br>
					</div>
					<div class="buttoncontainer">
						<a class="linkbutton" href="Blooks.html" style="background-color:#9a49aa;">
							<i class="fas fa-suitcase"></i>
							<div class="buttontext">Blook List & rarities</div>
						</a>
						<a class="linkbutton" href="factory-earnings.html" style="background-color:#995b3c;">
							<i class="fas fa-industry"></i>
							<div class="buttontext">Factory Earnings</div>
						</a>	
						<br>
					</div>
					<div class="buttoncontainer">
						<a class="linkbutton" href="gold-rush.html" style="background-color:#ffcd05;">
							<i class="fas fa-coins"></i>
							<div class="buttontext">Gold Rush Values</div>
						</a>
						<a class="linkbutton" href="music.html" style="background-color:#ff462b;">
							<i class="fas fa-music"></i>
							<div class="buttontext">Good Study Music</div>
						</a>
						<div>
							<div class="noclickcontainer">
								<div class="noclick" oncontextmenu="return false"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="footer">
					<p id="wat">Courtesy of: wat</p>
					<h1 class="notblooket">This page is a parody of Blooket</h1>
					<h2 class="madeby">Made by a Blooket fan.</h2>
				</div>
			</div>
		</div>
	</main>
